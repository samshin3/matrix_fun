This is a basic C program that does matrix multiplication given two valid matrices
...
April 16, 2026:
Added one dimensional linear regression with method of least squares

To run the program run the tester.sh script to compile and run the test2.in file
